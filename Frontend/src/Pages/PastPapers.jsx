...
function Searchcontents() {
  return (
    <div className="bg-[#D5E3FC] dark:bg-slate-400">
      <br />
      <div
    ...
    <div className=" mx-auto p-4 ml-8 mr-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10">
        {uploads.map((upload) => (
          <div
            key={upload.id}
            className=  " dark:bg-slate-900 dark:text-white bg-gray-100 p-3 sm:p-4 shadow-lg shadow-gray-400 rounded-xl relative flex flex-col items-center text-center transition-all duration-300 ease-out hover:scale-105 hover:shadow-2xl cursor-pointer"
          >
            <img
              src={upload.image}
              alt={upload.title}
